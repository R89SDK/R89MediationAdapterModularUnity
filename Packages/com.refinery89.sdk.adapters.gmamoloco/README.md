...
| --- | --- |
| Android | `com.refinery89.androidsdk.adapters:gmaMoloco:1.2.5-beta.2` |
| iOS | `R89GmaMolocoAdapter` `1.2.5-beta.2` (minTargetSdk 13.0) |
...
```bash
openupm add com.refinery89.sdk.adapters.gmamoloco
```
...
```text
https://github.com/R89SDK/R89MediationAdapterModularUnity.git?path=Packages/com.refinery89.sdk.adapters.gmamoloco
```
