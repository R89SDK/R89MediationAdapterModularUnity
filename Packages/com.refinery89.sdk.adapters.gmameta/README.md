...
| --- | --- |
| Android | `com.refinery89.androidsdk.adapters:gmaMeta:1.2.5-beta.2` |
| iOS | `R89GmaMetaAdapter` `1.2.5-beta.2` (minTargetSdk 13.0) |
...
```text
https://github.com/R89SDK/R89MediationAdapterModularUnity.git?path=Packages/com.refinery89.sdk.adapters.gmameta
```
