...
| --- | --- |
| Android | `com.refinery89.androidsdk:mediation-base:1.2.5-beta.2` |
| iOS | `R89MediationBase` `1.2.5-beta.2` (minTargetSdk 13.0) |
...
```text
https://github.com/R89SDK/R89MediationAdapterModularUnity.git?path=Packages/com.refinery89.sdk.mediation-base
```
