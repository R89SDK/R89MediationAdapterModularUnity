...
| --- | --- |
| Android | `com.refinery89.androidsdk.adapters:gmaInMobi:1.2.5-beta.2` |
| iOS | `R89GmaInMobiAdapter` `1.2.5-beta.2` (minTargetSdk 13.0) |
...
```bash
openupm add com.refinery89.sdk.adapters.gmainmobi
```
...
```text
https://github.com/R89SDK/R89MediationAdapterModularUnity.git?path=Packages/com.refinery89.sdk.adapters.gmainmobi
```
