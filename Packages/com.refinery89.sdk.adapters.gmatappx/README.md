...
| --- | --- |
| Android | `com.refinery89.androidsdk.adapters:gmaTappx:1.2.5-beta.2` |
| iOS | `R89GmaTappxAdapter` `1.2.5-beta.2` (minTargetSdk 13.0) |
...
```bash
openupm add com.refinery89.sdk.adapters.gmatappx
```
...
```text
https://github.com/R89SDK/R89MediationAdapterModularUnity.git?path=Packages/com.refinery89.sdk.adapters.gmatappx
```
