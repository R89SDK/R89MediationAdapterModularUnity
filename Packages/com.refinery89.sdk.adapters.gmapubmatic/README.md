# Refinery89 GMA Adapter - PubMatic
...
| --- | --- |
| Android | `com.refinery89.androidsdk.adapters:gmaPubMatic:1.2.5-beta.2` |
| iOS | `R89GmaPubMaticAdapter` `1.2.5-beta.2` (minTargetSdk 13.0) |
...
```bash
openupm add com.refinery89.sdk.adapters.gmapubmatic
```
...
```text
https://github.com/R89SDK/R89MediationAdapterModularUnity.git?path=Packages/com.refinery89.sdk.adapters.gmapubmatic
```
