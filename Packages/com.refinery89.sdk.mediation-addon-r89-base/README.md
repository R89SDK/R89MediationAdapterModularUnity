# Refinery89 Mediation Addon - R89 Base (Modular)
...
| --- | --- |
| Android | `com.refinery89.androidsdk:mediation-addon-r89-base:1.2.5-beta.2` |
| iOS | `R89MediationAddonR89Base` `1.2.5-beta.2` (minTargetSdk 13.0) |
...
```text
https://github.com/R89SDK/R89MediationAdapterModularUnity.git?path=Packages/com.refinery89.sdk.mediation-addon-r89-base
```
